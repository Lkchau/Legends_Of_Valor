...
public class Market {
    ...
    public void buyItem(String itemType, Character charInfo){
//        Character charInfo = (UserPrompt.getPrompt().promptMenuOptionsValueChar(p.getPartyMenu(),false));
        if(charInfo instanceof Hero){
            System.out.println(padRight("Name", charInfo.getName().getName().length()) + " " + "Money\n" + charInfo.getName() + " " + ((Hero) charInfo).getWallet());
        }
    ...
    public void sellItem(Character charInfo){
//        Character charInfo = (UserPrompt.getPrompt().promptMenuOptionsValueChar(p.getPartyMenu(),false));
        if(charInfo instanceof Hero) {
            System.out.println(padRight("Name", charInfo.getName().getName().length()) + " " + "Money\n"+ charInfo.getName() + " " + ((Hero) charInfo).getWallet());
