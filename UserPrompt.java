...
public class UserPrompt {
    ...
    public <T> int promptList(List<T> choices, String prompt){
        int i = 0;
        for(; i < choices.size();i++){
            System.out.println(padRight("("+(i+1)+")",5) + choices.get(i));
        }
        return promptForIntWithPrompt("Please choose " + prompt,1,choices.size(),false);
    }
